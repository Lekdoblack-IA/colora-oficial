      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8 text-center lg:text-left">
          <div className="space-y-4">
            ...
            <p className="text-xl text-gray-600 max-w-lg mx-auto lg:mx-0 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          {/* Prova Social */}
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-6 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
            ...
            <div className="flex items-center space-x-1">
              ...
              <span className="ml-2 text-gray-600">4.9/5 (234 avaliações)</span>
            </div>
          </div>
        </div>
