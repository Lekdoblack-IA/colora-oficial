...
const PricingSection = ({ isLoggedIn = false, onAuthModalOpen }: PricingSectionProps) => {
  const [selectedPackage, setSelectedPackage] = useState('plus');
  const navigate = useNavigate();
  const selectedPkg = packages.find(pkg => pkg.id === selectedPackage);

  const handleTransformClick = () => {
    console.log('Transform photo button clicked, isLoggedIn:', isLoggedIn);
  ...
  return (
    <section id="pricing" className="px-4 bg-gray-50 py-[40px]">
          ...
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
            ...
            <div className="p-8 text-center flex flex-col items-center">
              ...
              <Button 
                ...
                className="w-full bg-gradient-to-r from-pink-500 to-red-500 hover:from-pink-600 hover:to-red-600 text-white rounded-full font-semibold mb-4 h-auto text-base px-0 py-[17px]"
              >
