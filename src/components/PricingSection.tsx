        ...
        <div className="max-w-md mx-auto">
          ...
          return <div key={pkg.id} className="relative bg-white rounded-3xl border border-black p-8 shadow-lg hover:border-transparent hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                ...
                <div className="text-center mb-6">
                  <h3 className="font-semibold text-gray-800 text-3xl">{pkg.name}</h3>
                </div>

                {/* 2. Quantidade de Desenhos no Pacote */}
                <div className="text-center mb-6">
                  <div className="flex items-center justify-center space-x-2">
                    <span className="font-semibold text-sm my-0 mx-0 py-0 text-gray-700">
                ...
                <div className="text-center mb-6">
                  <div className="mb-4">
                    <div className="text-2xl font-bold text-gray-800 mb-1 rounded-none">
                    ...
                    <div className="flex items-baseline justify-center space-x-2">
                      ...
                      {pkg.pricePerCredit < 5 && <span className="text-sm text-gray-400 line-through">R$5</span>}
                    </div>
                  </div>
