          ...
          <Tabs defaultValue="login" className="w-full">
            ...
            <TabsContent value="login" className="space-y-4 mt-6">
              <Button 
                ...
                className="w-full bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 rounded-2xl h-12 font-medium shadow-sm hover:shadow-md transition-all duration-300"
              >
