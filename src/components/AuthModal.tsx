  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md border-0 bg-white rounded-3xl shadow-2xl overflow-hidden p-0">
        ...
        <div className="bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 p-6 text-white text-center">
          ...
          <Tabs defaultValue="login" className="w-full">
            ...
            <TabsContent value="login" className="space-y-4 mt-6">
              <Button 
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-2xl h-12 font-medium shadow-lg hover:shadow-xl transition-all duration-300"
              >
              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <div className="relative mt-1">
                    ...
                    <Input 
                      ...
                      placeholder="••••••••" 
                      disabled={isSubmitting}
                      className="pl-10 pr-10 h-12 rounded-2xl border-gray-200 focus:border-pink-500 focus:ring-pink-500" 
                    />
                    <button 
                      type="button" 
                ...
                <Button 
                  ...
                  disabled={isSubmitting}
                  className="w-full bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 hover:from-purple-500 hover:via-pink-700 hover:to-red-700 text-white rounded-2xl h-12 font-medium shadow-lg hover:shadow-xl transition-all duration-300"
                >
                  {isSubmitting ? (
                    <>
            ...
            <TabsContent value="signup" className="space-y-4 mt-6">
              <div className="space-y-4">
                ...
                <Button 
                  ...
                  disabled={isSubmitting}
                  className="w-full bg-gradient-to-r from-purple-600 via-pink-600 to-red-600 hover:from-purple-700 hover:via-pink-700 hover:to-red-700 text-white rounded-2xl h-12 font-medium shadow-lg hover:shadow-xl transition-all duration-300"
                >
                  {isSubmitting ? (
                    <>
                      <Loader2 className="mr-2 h-4 w-4 animate-spin" />
